...
const config = {
    server: "localhost", // Define o endereço do servidor de banco de dados
    authentication: {
        type: "default", // Define o tipo de autenticação como padrão
        options: {
            userName: "sa", // Define o nome de usuário para autenticação
            password: "gustavo" // Define a senha para autenticação
        }
    },
    options: {
        database: "select_consulta", // Define o nome do banco de dados
